...
public class Mushroom extends Monster {
	private Image stand = new Image("file:images/monster/Mushroom/Run.png");
	private Image im_att = new Image("file:images/monster/Mushroom/Attack.png");
	...
	public Mushroom(int px, int py, double dif) {
